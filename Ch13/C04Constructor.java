...
public class C04Constructor {
	...
	// 클래스를 사용하여 객체를 생성 시 new 키워드를 사용하면 해당 클래스이 생성자가 1회 호출
	// 생성자는 주로 객체의 초기화를 수행
	// 기본적으로 클래스 내에 생성자(Constructor)가 명시되엉 씨지 않다면 디폴트 생성자(Default Constructor == 기본생성자)
	// 가 자동적으로 주입돼 사용
	...
	public C04Constructor(String name, int age) {
		System.out.println("매개 변수 생성자 입니다!");
		this.name = name;
		this.age = age;
	}
	...
	// ### this keyword ###
	// 클래스 내에서 사용되는 예약어
	// 생성되는 객체의 위처정보를 가져오는데 사용됨.
	
	// 멤버변수 vs 매개변수 구별
	// this.name = name
	
	// ## this() ##
	// Overloading(오버로딩)된 다른 생성자 호출 O
